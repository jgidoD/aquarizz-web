  ...
  return (
    <div className="container">
      <header className="header" style={{ position: "relative" }}>
        ...
        <Contact
          onClose={() => {
            setShowEmailService(false);
          }}
          show={showEmailService}
        />
        <div className="loginBtnContainerMobile" onClick={handleToggleLogin}>
          <button>Login</button>
        </div>
      </header>
      ...
      <main className="hero">
        ...
        <div
          className="heroForm"
          style={{ display: isTablet ? (!showBtn ? "none" : "block") : "" }}
        >
          <div className="card">
            {error && (
              <span
